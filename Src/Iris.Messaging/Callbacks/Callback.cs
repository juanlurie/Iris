    ...
    public class Callback : ICallback
    {
        ...
        void ICallback.Register<T>(Action<T> callback, object synchronizer)
        {
            ...
            if (HttpContext.Current != null && synchronizer == null)
                throw new ArgumentNullException("synchronizer", "Iris has detected that you're running in a web context but have passed in a null synchronizer. Please pass in a reference to a System.Web.UI.Page or a System.Web.Mvc.AsyncController.");
